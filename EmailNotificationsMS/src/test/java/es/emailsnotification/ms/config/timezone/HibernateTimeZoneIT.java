package es.emailsnotification.ms.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import es.emailsnotification.ms.IntegrationTest;
import es.emailsnotification.ms.repository.timezone.DateTimeWrapper;
import es.emailsnotification.ms.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
