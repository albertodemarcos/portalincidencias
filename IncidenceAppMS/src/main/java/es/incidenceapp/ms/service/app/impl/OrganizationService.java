...
public class OrganizationService implements IOrganizationService {
	...
	public ActionResponse getOrganization(Long organizationDTOId) {
		...
		if( organizationDTOId == null || organizationDTOId <= 0L) 
		{
			...
			return new ActionResponse(MicroserviceConstans.NOK, "The organizationDTOId has not ID" );
		}
		
		ActionResponse _response = this.httpMicroserviceService.getEntity(organizationDTOId, MicroserviceConstans.PORTAL_INCIDENCE, MicroserviceConstans.ORGANIZATION);
	...
	public ActionResponse createOrganization(OrganizationDTO organizationDTO, BindingResult result) {
		...
		if( organizationDTO == null ) {
			...
			return new ActionResponse(MicroserviceConstans.NOK, "The organizationDTO has defects.", result.getFieldErrors().toString() );
		}
		
		ActionResponse _response = this.httpMicroserviceService.saveEntity(organizationDTO, MicroserviceConstans.PORTAL_INCIDENCE, MicroserviceConstans.ORGANIZATION);
	...
	public ActionResponse deleteOrganizationId(Long organizationDTOId) {
		...
		ActionResponse _response = this.httpMicroserviceService.deleteEntity(organizationDTOId, MicroserviceConstans.PORTAL_INCIDENCE, MicroserviceConstans.ORGANIZATION);
	...
	public ActionResponse postOrganizations(OrganizationFilterDTO organizationFilterDTO, Pageable page) {
		...
		if( organizationFilterDTO == null ) {
			...
			return new ActionResponse(MicroserviceConstans.NOK, "The organizationFilterDTO has defects." );
		}
		
		ActionResponse _response = this.httpMicroserviceService.listEntities(organizationFilterDTO, MicroserviceConstans.PORTAL_INCIDENCE, MicroserviceConstans.ORGANIZATION);
