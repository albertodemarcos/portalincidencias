package es.portalincidencias.ms.web.rest;

import static es.portalincidencias.ms.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import es.portalincidencias.ms.IntegrationTest;
import es.portalincidencias.ms.config.Constants;
import es.portalincidencias.ms.domain.User;
import es.portalincidencias.ms.repository.AuthorityRepository;
import es.portalincidencias.ms.repository.UserRepository;
import es.portalincidencias.ms.security.AuthoritiesConstants;
import es.portalincidencias.ms.service.UserService;
import es.portalincidencias.ms.service.dto.AdminUserDTO;
import es.portalincidencias.ms.service.dto.PasswordChangeDTO;
import es.portalincidencias.ms.service.dto.UserDTO;
import es.portalincidencias.ms.web.rest.vm.KeyAndPasswordVM;
import es.portalincidencias.ms.web.rest.vm.ManagedUserVM;
